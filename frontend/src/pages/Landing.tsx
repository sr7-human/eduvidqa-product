...
export function Landing() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0e1a] text-gray-900 dark:text-gray-100">
      {/* Header */}
      ...
      {/* How it works */}
      <section className="max-w-5xl mx-auto px-6 py-16 border-t border-gray-200 dark:border-gray-700">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={s.n} className="text-center">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 flex items-center justify-center font-bold text-lg">
                {s.n}
              </div>
              <h3 className="font-semibold text-lg mb-2">{s.t}</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">{s.d}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <footer className="border-t border-gray-200 dark:border-gray-700 py-8 text-center text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="mt-2">
          <Link to="/privacy" className="hover:text-gray-700 dark:hover:text-gray-300 mr-4">Privacy Policy</Link>
